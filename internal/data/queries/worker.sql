...
-- name: GetBinding :one
SELECT * FROM network_provider_bindings WHERE tenant_id=$1 AND vpc_id=$2;
...
WHERE tenant_id=sqlc.arg(tenant_id) AND vpc_id=sqlc.arg(vpc_id) AND binding_id=sqlc.arg(binding_id)
