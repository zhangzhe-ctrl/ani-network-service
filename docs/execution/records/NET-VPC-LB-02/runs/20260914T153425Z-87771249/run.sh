...
cd /home/ubuntu/workspace/ani-network-service-runs/snat-20260914T153425Z-87771249
printf '%s  source.tar.gz\n' 166283f4465d85082619df49a87dd1ea649de5062661e1ce91f891e2aeafcedd | sha256sum -c -
mkdir source
