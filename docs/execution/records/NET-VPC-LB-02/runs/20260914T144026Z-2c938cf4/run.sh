...
cd /home/ubuntu/workspace/ani-network-service-runs/snat-20260914T144026Z-2c938cf4
printf '%s  source.tar.gz\n' d87a6269ca2a9329f20f73d7f05eda35916750af7f446ef9e058884b7bf972c9 | sha256sum -c -
mkdir source
...
printf '%s\n' "$$" > ../shell.pid
set +e
flock -n /home/ubuntu/.local/share/ani-network-service/net05a-heavy.lock systemd-run --user --scope --quiet -p CPUQuota=200% -p MemoryMax=2300M -p MemorySwapMax=0 env GOMAXPROCS=2 GOFLAGS=-p=2 GOMEMLIMIT=1500MiB scripts/net05a-resource-guard .tools/bin/sqlc generate 2>&1 | tee ../command.log
result=$?
set -e
printf '%s\n' "$result" > ../command.exit
