...
cd /home/ubuntu/workspace/ani-network-service-runs/snat-20260910T141833Z-3a83b632
printf '%s  source.tar.gz\n' 2225fc388494760356cd94445a9bcae8d51b0da784f8e0b32e757c35c5d03ce6 | sha256sum -c -
mkdir source
...
printf '%s\n' "$$" > ../shell.pid
set +e
flock -n /home/ubuntu/.local/share/ani-network-service/net05a-heavy.lock systemd-run --user --scope --quiet -p CPUQuota=200% -p MemoryMax=2300M -p MemorySwapMax=0 env GOMAXPROCS=2 GOFLAGS=-p=2 GOMEMLIMIT=1500MiB scripts/net05a-resource-guard go mod tidy 2>&1 | tee ../command.log
result=$?
set -e
printf '%s\n' "$result" > ../command.exit
