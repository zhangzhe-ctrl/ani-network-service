...
cd /home/ubuntu/workspace/ani-network-service-runs/snat-20260910T133354Z-26c9a687
printf '%s  source.tar.gz\n' 4ae4f6581593015a72a35279913076d97eb0d6af05edc1397aac1899926e98fb | sha256sum -c -
mkdir source
