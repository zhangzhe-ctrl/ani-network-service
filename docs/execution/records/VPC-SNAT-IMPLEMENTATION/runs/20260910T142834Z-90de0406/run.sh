...
cd /home/ubuntu/workspace/ani-network-service-runs/snat-20260910T142834Z-90de0406
printf '%s  source.tar.gz\n' 90e0e84fffda449bfb68548fb468d5a77462a1b6d80f72a0c364cf681f45c520 | sha256sum -c -
mkdir source
...
printf '%s\n' "$$" > ../shell.pid
set +e
flock -n /home/ubuntu/.local/share/ani-network-service/net05a-heavy.lock systemd-run --user --scope --quiet -p CPUQuota=200% -p MemoryMax=2300M -p MemorySwapMax=0 env GOMAXPROCS=2 GOFLAGS=-p=2 GOMEMLIMIT=1500MiB scripts/net05a-resource-guard make verify 2>&1 | tee ../command.log
result=$?
set -e
printf '%s\n' "$result" > ../command.exit
