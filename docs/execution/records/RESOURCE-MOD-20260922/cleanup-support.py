...
r=pathlib.Path('/home/chabking/workspace/ani-resource-service-runs/rsmod-20260921T1640Z');base='http://127.0.0.1:44869'
receipt=json.loads((r/'evidence/live-support-created.json').read_text())['objects'];out=r/'evidence/support-cleanup.json';assert not out.exists()
assert subprocess.run(['systemctl','--user','is-active','--quiet','resource-live-20260922']).returncode!=0
